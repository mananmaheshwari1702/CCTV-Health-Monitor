...
export function Header({ onMobileMenuToggle, sidebarCollapsed }: HeaderProps) {
    ...
    return (
        <header
            className={`fixed top-0 right-0 left-0 z-30 h-16 bg-white border-b border-slate-200 transition-all duration-300 
        ...
        >
            <div className="flex items-center justify-between h-full px-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-lg md:text-xl font-bold text-slate-900">{currentTitle}</h1>
